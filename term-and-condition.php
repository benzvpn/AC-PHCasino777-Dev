...
<head>
    ...
    <meta property="og:url" content="https://allcasino.bet/term-and-condition">
    <meta property="og:image" content="#editme#">

    <link rel="canonical" href="https://allcasino.bet/term-and-condition" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "image": ["/build/web/all-casino/img/meta-1x1.jpg", "/build/web/all-casino/img/meta-4x3.jpg", "/build/web/all-casino/img/meta-16x9.jpg"],
            "name": "All Casino บาคาร่า เสือมังกร คาสิโนออนไลน์ ได้เงินจริง แอพบาคาร่า",
            "url": "https://allcasino.bet/term-and-condition"
        }
    </script>
</head>
...
<body class="">
    ...
    <div id="main__content" class="x-main-content-container">
        <div class="x-term-and-condition -home">
            <div class="container">
                <div class="-notice-box">
                    <div class="-title">
                        <img src="/build/web/all-casino/img/logo.png" alt="Sa Gaming logo">
                    </div>
                    <div class="-block-content-term-and-condition">
                        <div class="row m-0 p-lg-5 py-5 px-4">
