...
<meta property="og:url" content="https://allcasino.bet/">
<meta property="og:image" content="#editme#">

<link rel="canonical" href="https://allcasino.bet/" />
...
<div class="x-contact-us 1">
            ...
            <a href="https://lin.ee/hGWtbsg" target="_blank">
                <img src="/build/web/all-casino/img/ic_line.png"
                     alt="All Casino ติดต่อเรา" class="-img-default">
                <img src="/build/web/all-casino/img/ic_line_hover.png"
                     alt="All Casino ติดต่อเรา" class="-img-hover">
            </a>
        </div>
        ...
        <div class="container -inner-wrapper">
            <div>
                <div class="-title" data-animatable="fadeInUp"
                     data-delay="500">
                    <img src="/build/web/all-casino/img/logo.gif" alt="All Casino logo"
                         class="-logo-title">
                    <img src="/build/web/all-casino/img/coin.gif"
                         alt="All Casino logo" class="-logo-coin">
                </div>
                <div>
                    <h2 data-animatable="fadeInUp" data-delay="500"
                        class="text-white mt-2 mb-0 h5 -sub-title text-center font-weight-normal">บาคาร่า คาสิโนออนไลน์ sagaming  wmcasino sexygaming</h2>
                </div>
            </div>

            
<div class="x-modal modal" id="registerModal"
...
<div class="x-modal modal" id="resetPasswordModal"
     tabindex="-1" role="dialog" aria-hidden="true"
...
>
            ...
            <div class="row mt-3 -btn-actions justify-content-center" data-animatable="fadeInUp" data-delay="700">
                        ...
                        <button type="button" class="btn btn-primary btn-block -register-button" data-toggle="modal"
                                data-target="#registerModal">สมัครสมาชิก
                        </button>
                    </div>
                    <div class="col-8 col-md-4 col-lg-3 offset-2 offset-md-4 offset-lg-0 d-none d-lg-block">
                        <a href="/lobby" target="_blank"
                           class="btn btn-primary btn-block -demo-top-button">
                            <img src="/build/web/all-casino/img/ic-blackjack.png"
                                 alt="All casino blackjack png" class="-icon-blackjack">
                            ทดลองเล่น
                        </a>
                    </div>
                            </div>
        ...
        <a href="#0" class="d-flex flex-md-column flex-row"
                                          data-toggle="modal" data-target="#registerModal">                            <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_deposit_withdraw.png"
                         alt="icon register" class="-ic-register">
                </div>
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">รวดเร็วทันใจ สนุกได้ทุกเวลา</span>
                    ...
                    <img src="/build/web/all-casino/img/ic_service_24_7.png"
                         alt="icon register" class="-ic-otp">
                </div>
                        <div class="text-left text-md-center">
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">บริการด้วยใจ พร้อมดูแล 24 ชั่วโมง</span>
                                                                                                                    ...
                                                                                                                    <div class="col-11 col-sm-9 col-md-4 mb-lg-0 mb-2 text-center -box d-flex align-items-start d-md-block -box">
                                    <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_consistency.png"
                         alt="icon register" class="-ic-bank">
                </div>
                        <div class="text-left text-md-center">
    ...
    <section>
        <div class="x-index-tab-container">
            <div class="container">
                    ...
                    <img src="/build/web/all-casino/img/line-long-glow.png"
                         alt="Line long glow png" class="-line-glow">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 text-center position-relative">
                ...
                <div class="-snippet-container">
                                            <img src="/build/web/all-casino/img/box-up.png"
                             alt="All Casino" class="-banner -box-up">
                                            <img src="/build/web/all-casino/img/box-main.png"
                             alt="All Casino" class="-banner -box-main">
                                            <img src="/build/web/all-casino/img/box-coin-1.png"
                             alt="All Casino" class="-banner -box-coin-1">
                                            <img src="/build/web/all-casino/img/box-coin-2.png"
                             alt="All Casino" class="-banner -box-coin-2">
                                            <img src="/build/web/all-casino/img/box-sign-1.png"
                             alt="All Casino" class="-banner -box-sign-1">
                                            <img src="/build/web/all-casino/img/box-sign-2.png"
                             alt="All Casino" class="-banner -box-sign-2">
                                    </div>
            </div>
        </div>
    </div>
    <div class="-middle-wrapper">
        <div class="container">
            ...
            <div class="row -box-wrapper">
                        ...
                        <div class="-box">
                            <div class="-content">
                                <img src="/build/web/all-casino/img/ic_register.png"
                                     alt="Allcasino icon png" class="-ic-register">
                                <div class="-desc-wrap">
                        ...
                        <div class="-box">
                            <div class="-content">
                                <img src="/build/web/all-casino/img/ic_otp.png"
                                     alt="Allcasino icon png" class="-ic-otp">
                                <div class="-desc-wrap">
                        ...
                        <div class="-box">
                            <div class="-content">
                                <img src="/build/web/all-casino/img/ic_bank.png"
                                     alt="Allcasino icon png" class="-ic-bank">
                                <div class="-desc-wrap">
            ...
            <div class="-lobby-logo-section">
                                ...
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/asia-gaming-logo-circle.png"
                                    ...
                                    <ul class="-nav-container-slot">
                                                                                                                                                        <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/skill-game-cover-vertical.png"
                                     class="-logo" alt="skill-game logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/skill-game-logo-horizontal.png"
                                         class="-logo mt-2" alt="skill-game logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/evo-play-cover-vertical.png"
                                     class="-logo" alt="evo-play logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/evo-play-logo-horizontal.png"
                                         class="-logo mt-2" alt="evo-play logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/netent-slot-cover-vertical.png"
                                     class="-logo" alt="netent-slot logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/netent-slot-logo-horizontal.png"
                                         class="-logo mt-2" alt="netent-slot logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/sp-cover-vertical.png"
                                     class="-logo" alt="sp logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/sp-logo-horizontal.png"
                                         class="-logo mt-2" alt="sp logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/habanero-cover-vertical.png"
                                     class="-logo" alt="habanero logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/habanero-logo-horizontal.png"
                                         class="-logo mt-2" alt="habanero logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/joker-cover-vertical.png"
                                     class="-logo" alt="joker logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/joker-logo-horizontal.png"
                                         class="-logo mt-2" alt="joker logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/ps-cover-vertical.png"
                                     class="-logo" alt="ps logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/ps-logo-horizontal.png"
                                         class="-logo mt-2" alt="ps logo png">
                                                            </li>
                                            </ul>
                                    <ul class="-nav-container-other">
                                                                                                                                                        <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/pinnacle-cover-vertical.png"
                                     class="-logo" alt="pinnacle logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/pinnacle-logo-horizontal.png"
                                         class="-logo mt-2" alt="pinnacle logo png">
                                                            </li>
                                                    <li class="-nav-item">
                                <img src="https://core.igame.bet/build/admin/img/lobby_main/imsb-cover-vertical.png"
                                     class="-logo" alt="imsb logo png">
                                                                    <img src="https://core.igame.bet/build/admin/img/lobby_main/imsb-logo-horizontal.png"
                                         class="-logo mt-2" alt="imsb logo png">
                                                            </li>
                                            </ul>
                            </div>
        </div>
...
<div class="x-tab-manual">
    ...
    <div class="container -container-wrapper pt-4">
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">กรอกเลขบัญชีของคุณพร้อมชื่อให้ถูกต้อง เข้าร่วมสนุกกับ All Casino ได้ทันที !</span>
                    ...
                    <div class="x-service-wrapper">
                        ...
                        <div class="row justify-content-center">
                                                                                                    <div class="col-11 col-sm-9 col-md-4 text-center -box d-flex align-items-start d-md-block -box">
        <a href="#0" class="d-flex flex-md-column flex-row"
                                          data-toggle="modal" data-target="#depositModal">                            <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_step_deposit.png"
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">"กรอกจำนวนเงิน" กด "ต้องการรับโปรโมชั่น" เพื่อรับโบนัสที่ต้องการ และกด "ยืนยัน"</span>
                                                                                                                                    ...
                                                                                                                                    <div class="col-11 col-sm-9 col-md-4 text-center -box d-flex align-items-start d-md-block -box">
                                    <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_step_deposit_add.png"
                         alt="icon register" class="-ic">
                </div>
                        <div class="text-left text-md-center">
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">สามารถ Scan QR Code เพื่อโอน หรือกด "คัดลอก" เลขบัญชี เพื่อโอนได้เช่นกัน</span>
                                                                                                                                    ...
                                                                                                                                    <div class="col-11 col-sm-9 col-md-4 text-center -box d-flex align-items-start d-md-block -box">
                                    <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_step_deposit_done.png"
                         alt="icon register" class="-ic">
                </div>
                        <div class="text-left text-md-center">
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">ส่งรายการฝาก ระบบจะตรวจสอบเงิน และ เติมเงินทันที</span>
                    ...
                    <div class="x-service-wrapper">
                        ...
                        <div class="row justify-content-center">
                                                                                                    <div class="col-11 col-sm-9 col-md-4 text-center -box d-flex align-items-start d-md-block -box">
        <a href="#0" class="d-flex flex-md-column flex-row"
                                          data-toggle="modal" data-target="#withdrawModal">                            <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_step_withdraw.png"
                         alt="icon register" class="-ic">
                </div>
                        <div class="text-left text-md-center">
                ...
                <span class="d-block d-lg-none text-muted-lighter f-5">"กรอกจำนวนเงิน ถอน" และกด "ยืนยัน"</span>
                                                                                                                                    ...
                                                                                                                                    <div class="col-11 col-sm-9 col-md-4 text-center -box d-flex align-items-start d-md-block -box">
                                    <div class="-ic-wrapper">
                    <img src="/build/web/all-casino/img/ic_step_withdraw_done.png"
                         alt="icon register" class="-ic">
                </div>
                        <div class="text-left text-md-center">
        ...
        <span class="text-white">ยังไม่มีข้อมูลในส่วนนี้</span>
                    ...
                    <a href="/lobby"
                       target="_blank"
                       class="btn btn-lg btn-primary btn-block pb-0 -demo-bottom">
                        <img src="/build/web/all-casino/img/ic-google-play.png"
                             alt="Allcasino icon google play png" class="-ic-google"> ทดลองเล่น
                    </a>
                </div>
                        </section>
...
<div class="x-modal modal" id="alertModal"
     tabindex="-1" role="dialog" aria-hidden="true"
...
<div class="x-modal modal" id="loginModal"
     tabindex="-1" role="dialog" aria-hidden="true"
      data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true"
>
                    <div class="modal-dialog -modal-size " role="document">
